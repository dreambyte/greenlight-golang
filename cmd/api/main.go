...
import (
	...
	_ "github.com/lib/pq"
	"greenlight.victran/internal/data"
	"greenlight.victran/internal/jsonlog"
	"greenlight.victran/internal/mailer"
)
...
func main() {
	...
	flag.StringVar(&cfg.smtp.username, "smtp-username", "4ac48bcc01985f", "SMTP username")
	flag.StringVar(&cfg.smtp.password, "smtp-password", "91af30208277cd", "SMTP password")
	flag.StringVar(&cfg.smtp.sender, "smtp-sender", "Greenlight <no-reply@greenlight.victran>", "SMTP sender")
